...
public class Player extends Entity
{
	...
	/**
	 * Player's function setIndex modifies the player's position on the
	 * leaderboard
	 *
	 * @param newIndex
	 */
	...
	/**
	 * Player's function usePotion increases the player's health and removes the
	 * potion from the array of potions
	 *
	 * @param index
	 */
	...
	/**
	 * Player's field potions represents the potions (up to MAX_INV) the player
	 * has
	 */
	private Item potions[] = new Item[MAX_INV];
	/**
	 * Player's constant field MAX_INV represents how many potions the player
	 * can hold
	 */
	private static final int MAX_INV = 10;
	/**
	 * Player's field maxArray represents how many potions the player currently
	 * has
	 */
