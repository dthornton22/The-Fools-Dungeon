...
public class Save
{
	...
	/**
	 * Writes input name to names.txt file in main directory Will create if file
	...
	public void write(String name)
	{
		 ...
		 * throw if successful name will be written to file and closed
		 */
		try
		{
	...
	/**
	 * Reads names.txt file for all listed names and copies into ArrayList for
	...
	public void read()
	{
		 ...
		 * throw if successful names will be read and copied to ArrayList then
		 * closed
		 */
		try
		{
	...
	/**
	 * Clears names from names.txt file parameter name string to write
	 */
	public void clear()
	{
		/**
